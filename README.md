Note, the Hylo compiler is in an early phase of development, so expect things to break. If you notice issues, please
submit them either for the [Hylo compiler](https://github.com/hylo-lang/hylo-new/issues), for
the [VSCode extension](https://github.com/hylo-lang/vscode-hylo/issues) or
the [language server](https://github.com/hylo-lang/hylo-language-server/issues).

If you want to get involved with developing Hylo, please reach out
on [Slack](https://join.slack.com/t/val-qs97696/shared_invite/zt-1z3dsblrq-y4qXfEE6wr6uMEJSN9uFyg).

## Actions
- Hylo: Restart Language Server
- Hylo: Update Language Server
- Hylo: Focus on Implicit Context View
...
> Disclaimer: Auto-completion is still WIP, and some features are incomplete for generic expressions.

> The extension contains some commands related to running/debugging a Hylo program. These are a legacy
> from the old compiler, they won't work yet with the [new compiler](https://github.com/hylo-lang/hylo-new).
